var data = {
  ...
  "userjourneys": [
    {
      "title": "Live Service (Mixed sources - Jan 2017)",
      "path": [{
        "caption": "Sign in page",
        "imgref": "images/web-qa/sign-in-page.png",
        "note": "Agents sign in with their Government Gateway account."
      },{
        "caption": "Joining the new service",
        "imgref": "images/web-qa/joining-service.png",
        ...
        "imgref": "images/web-qa/agents-homepage.png",
        ...
        "imgref": "images/web-qa/switch-yes-selected.png",
        ...
        "imgref": "images/web-qa/PAYE-client-list.png",
        ...
        "imgref": "images/web-qa/confirming-clients.png",
        ...
        "imgref": "images/web-qa/removing-client-message.png",
        ...
        "imgref": "images/web-qa/client-search.png",
        "note": "Allows agents to search for a specific client."
      },{
        "caption": "Client L&P statement",
        "imgref": "images/web-qa/client-summary.png",
        "note": "Shows an overview of the client's payment history and each of their PAYE accounting periods."
      },{
        "caption": "Allocations tab",
        "imgref": "images/web-qa/allocations-tab.png",
        "note": "Shows a summary list of client's allocations by month and year."
      },{
        "caption": "Webchat offer",
        "imgref": "images/web-qa/allocations-chat-offer.JPG",
        "note": "If an adviser is available for webchat - then the webchat pop up offer is displayed."
      },{
        "caption": "Webchat start chat",
        "imgref": "images/web-qa/allocations-chat-start.JPG",
        "note": "An agent can initiate webchat with the adviser by entering name and email and a message."
      },{
        "caption": "Webchat messages",
        "imgref": "images/web-qa/allocations-chat-messages.JPG",
        "note": "Agent and adviser can easily send and receive messages."
      },{
        "caption": "Webchat feedback",
        "imgref": "images/web-qa/allocations-chat-feedback.JPG",
        "note": "Once the chat has finished the agent is prompted to leave feedback on the service in a simple form  ."
      },{
        "caption": "Allocations tab expanded",
        "imgref": "images/web-qa/allocations-tab-expanded.png",
        "note": "Allows monthly allocations to be expanded to show further details."
      },{
        "caption": "Payments tab",
        "imgref": "images/web-qa/payments-tab.png",
        "note": "Shows a summary of payments made by the client by month"
        },{
        "caption": "Payments tab expanded",
        "imgref": "images/web-qa/payments-tab-expanded.png",
        "note": "Allows monthly payments to be expanded to show allocations and dates."
      },{
        "caption": "HMRC processing times",
        "imgref": "images/web-qa/HMRC-processing-times.png",
        "note": "Gives agents a list of HMRC processing times."
       },{
        "caption": "Survey",
        "imgref": "images/web-qa/sign-out-survey.png",
